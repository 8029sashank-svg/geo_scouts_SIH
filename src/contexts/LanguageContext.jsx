...
export const TRANSLATIONS = {
  en: {
    ...
    // Gov Additions
    govTitleGovOfMah: 'Government of Maharashtra',
    govTitleApp: 'Crop Disease & Pest Management System',
    navHome: 'Home',
    navServices: 'Farmer Services',
    navDiseaseDetect: 'Disease Detection',
    navCrops: 'Crops',
    navSchemes: 'Government Schemes',
    navAdvisory: 'Advisory',
    navContact: 'Contact',
    heroTitle: 'Identify Crop Diseases & Pests Early',
    heroSubtitle: 'Upload a crop image to identify possible diseases, pests and recommended management practices.',
    btnUpload: 'Upload Crop Image',
    btnAdvisory: 'Farmer Advisory',
    farmerServices: 'Farmer Services',
    serviceDisease: 'Crop Disease Detection',
    servicePest: 'Pest Detection',
    serviceTreatment: 'Recommended Management',
    serviceSchemes: 'Government Schemes',
    serviceOfficer: 'Contact Agriculture Officer',
    serviceAdvice: 'Farmer Advisory',
    moreInfo: 'More Information',
    diseaseDetectTitle: 'Identify Crop Disease',
    diseaseDetectSub: 'Upload a clear photo of the affected crop part.',
    uploadHere: 'Upload crop photo here',
    orUseCamera: 'or use camera to take photo',
    ...
    severity: 'Severity',
    recommendedManagement: 'Recommended Management',
    disclaimerPossible: 'Possible Disease',
    disclaimerConsult: 'Consult an agricultural expert for final diagnosis.',
    importantNotice: 'Important Notice',
    highRiskWarning: 'High risk of severe infection detected. It is recommended to contact an agricultural officer immediately.',
    contactOfficer: 'Contact Officer',
    requestVisit: 'Request Field Visit',
    officerBookingTitle: 'Agriculture Officer Field Visit',
    farmerName: 'Farmer Name',
    mobileNumber: 'Mobile Number',
    village: 'Village',
    taluka: 'Taluka',
    district: 'District',
    problemNature: 'Nature of Problem',
    prefDate: 'Preferred Date',
    prefTime: 'Preferred Time',
    sendRequest: 'Send Visit Request',
    govSchemesTitle: 'Government Schemes',
    agriGuidance: 'Agricultural Guidance',
    importantNotices: 'Important Notices',
    footerDevelopedFor: 'This system is developed for the Agriculture Department initiatives of the Government of Maharashtra.',
  ...
  mr: {
    ...
    // Gov Additions
    govTitleGovOfMah: 'महाराष्ट्र शासन',
    govTitleApp: 'पीक रोग व कीड व्यवस्थापन प्रणाली',
    navHome: 'मुख्यपृष्ठ',
    navServices: 'शेतकरी सेवा',
    navDiseaseDetect: 'रोग ओळख',
    navCrops: 'पिके',
    navSchemes: 'सरकारी योजना',
    navAdvisory: 'सल्ला / मार्गदर्शन',
    navContact: 'संपर्क',
    heroTitle: 'पिकांचे रोग व कीड लवकर ओळखा',
    heroSubtitle: 'पिकाच्या पानांचा किंवा झाडाचा फोटो अपलोड करून संभाव्य रोग, कीड आणि उपाययोजना यांची माहिती मिळवा.',
    btnUpload: 'पिकाचा फोटो अपलोड करा',
    btnAdvisory: 'शेतकरी मार्गदर्शक',
    farmerServices: 'शेतकरी सेवा',
    serviceDisease: 'रोग ओळख',
    servicePest: 'कीड ओळख',
    serviceTreatment: 'उपचार व उपाय',
    serviceSchemes: 'सरकारी योजना',
    serviceOfficer: 'कृषी अधिकारी',
    serviceAdvice: 'शेतकरी मार्गदर्शन',
    moreInfo: 'अधिक माहिती',
    diseaseDetectTitle: 'पिकाचा रोग ओळखा',
    diseaseDetectSub: 'पिकाच्या प्रभावित भागाचा स्पष्ट फोटो अपलोड करा.',
    uploadHere: 'पिकाचा फोटो येथे अपलोड करा',
    orUseCamera: 'किंवा कॅमेरा वापरून फोटो घ्या',
    selectPhoto: 'फोटो निवडा',
    analyzeDisease: 'रोगाचे विश्लेषण करा',
    resultTitle: 'विश्लेषणाचा निकाल',
    cropName: 'पिकाचे नाव',
    possibleDisease: 'संभाव्य रोग',
    affectedArea: 'प्रभावित भाग',
    severity: 'गंभीरता',
    recommendedManagement: 'शिफारस केलेल्या उपाययोजना',
    disclaimerPossible: 'संभाव्य रोग',
    disclaimerConsult: 'अंतिम निर्णयासाठी कृषी तज्ज्ञांचा सल्ला घ्या.',
    importantNotice: 'महत्त्वाची सूचना',
    highRiskWarning: 'पिकामध्ये गंभीर संसर्गाची शक्यता आढळली आहे. त्वरित कृषी अधिकाऱ्यांशी संपर्क साधण्याची शिफारस केली जाते.',
    contactOfficer: 'अधिकाऱ्यांशी संपर्क करा',
    requestVisit: 'क्षेत्र भेटीची विनंती करा',
    officerBookingTitle: 'कृषी अधिकारी क्षेत्र भेट',
    farmerName: 'शेतकऱ्याचे नाव',
    mobileNumber: 'मोबाईल क्रमांक',
    village: 'गाव',
    taluka: 'तालुका',
    district: 'जिल्हा',
    problemNature: 'समस्येचे स्वरूप',
    prefDate: 'भेटीची पसंतीची तारीख',
    prefTime: 'पसंतीची वेळ',
    sendRequest: 'क्षेत्र भेटीची विनंती पाठवा',
    govSchemesTitle: 'शासकीय योजना',
    agriGuidance: 'कृषी मार्गदर्शन',
    importantNotices: 'महत्त्वाच्या सूचना',
    footerDevelopedFor: 'ही प्रणाली महाराष्ट्र शासनाच्या कृषी विभागाच्या उपक्रमासाठी विकसित करण्यात आलेली आहे.',
    privacyPolicy: 'गोपनीयता धोरण',
    termsConditions: 'अटी व शर्ती',

    // Field Scout portal
    navDashboard: 'डॅशबोर्ड',
    navMissions: 'माझी मिशन्स',
    navFieldMap: 'क्षेत्र नकाशा',
    navNewSurvey: 'नवीन सर्वेक्षण',
    navScanTrap: 'सापळा स्कॅन करा',
    navMyReports: 'माझे अहवाल',
    navFieldGuide: 'क्षेत्र मार्गदर्शक',
    navNotifications: 'सूचना',
    navMyProfile: 'माझी प्रोफाइल',
    navNearby: 'जवळील प्रकरणे',
    navAssignments: 'माझी कामे',
    navVisits: 'शेत भेटी',
    navLibrary: 'ज्ञान भांडार',
    navChat: 'शेतकऱ्यांशी संवाद',
    navClusters: 'गट भेटी',
    navLeaderboard: 'गुणतक्ता',
    navCertificates: 'प्रमाणपत्रे',
    navCases: 'प्रकरणे',
    navVisitTab: 'भेट',
    fieldMissionLabel: 'क्षेत्रीय मिशन',
    startSurveyLabel: 'सर्वेक्षण सुरू करा',
    submitReportLabel: 'अहवाल सादर करा',
  },
};
