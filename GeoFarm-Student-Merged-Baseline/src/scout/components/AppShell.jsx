...
const DESKTOP_NAV = [
  ...
  { key: 'map', label: 'Farm Map', labelKey: 'navFieldMap', icon: Map },
  { key: 'library', label: 'Knowledge Library', labelKey: 'navLibrary', icon: BookOpen },
  { key: 'chat', label: 'Chat with Farmers', labelKey: 'navChat', icon: MessageCircle },
  { key: 'clusters', label: 'Cluster Visits', labelKey: 'navClusters', icon: Users },
  { key: 'leaderboard', label: 'Leaderboard', labelKey: 'navLeaderboard', icon: Trophy },
  { key: 'certificates', label: 'Certificates', labelKey: 'navCertificates', icon: Award },
...
const MOBILE_NAV = [
  ...
  { key: 'map', label: 'Map', labelKey: 'navFieldMap', icon: Map },
