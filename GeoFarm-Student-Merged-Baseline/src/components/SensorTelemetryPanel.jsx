          ...
          <div className="h-52 -ml-2 mt-4">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={chartData} margin={{ top: 5, right: 12, bottom: 0, left: 0 }}>
                ...
                <XAxis dataKey="time" tick={{ fontSize: 10, fill: '#4b5563' }} minTickGap={30} />
    ...
    <Card>
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 rounded bg-gov-bg border border-gov-border flex items-center justify-center shrink-0">
          <Icon size={16} className="text-gov-blue" />
        </div>
        <div className="flex-1 min-w-0">
          <p className="text-sm font-bold text-gov-navy truncate">{data.pathogen}</p>
